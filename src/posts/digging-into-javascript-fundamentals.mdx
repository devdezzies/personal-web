---
title: Let's start digging into Fundamentals JavaScript
...
Okay, now you have to started to **really** learn JS. Just write the code and see how it works, if there's any
problem it means you are in learning mode. Remember! don't just give up if you can't solve it, you can take your time
and comeback to resolve it. Enjoy your journey, sometimes you can slow down but don't ever stop.
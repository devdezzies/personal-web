---
title: Let's digging into Fundamentals JavaScript
...
problem it means you are in learning mode. Remember! don't just give up if you can't solve it, you can take you time
